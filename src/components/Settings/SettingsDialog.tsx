    ...
    geminiModels: [
      {
        id: "gemini-1.5-pro",
        name: "Gemini 1.5 Pro",
        description: "A powerful and reliable model, pioneering the massive 1M token context window. Ideal for deep analysis of very long documents, codebases, or videos."
      },
      {
        id: "gemini-2.0-flash",
        name: "Gemini 2.0 Flash",
        description: "A legacy fast-generation model. A previous-generation option for general-purpose tasks where a balance of speed and cost was needed."
      },
      {
        id: "gemini-2.5-pro",
        name: "Gemini 2.5 Pro",
        description: "The flagship model with state-of-the-art reasoning. Best for complex, mission-critical tasks and advanced, agentic workflows."
      },
      {
        id: "gemini-2.5-flash",
        name: "Gemini 2.5 Flash",
        description: "Lightning-fast and highly efficient. Optimized for low latency and high-throughput tasks like real-time conversations and large-scale summarization."
      }
    ],
    anthropicModels: [
      {
          ...
          <div className="space-y-4 mt-4">
            ...
            {modelCategories.map((category) => {
              ...
              const models = 
                ...
                console.log(`Models for ${category.key}:`, models);

...
export class ProcessingHelper {
  ...
  private async generateSolutionsHelper(signal: AbortSignal) {
    try {
      ...
      const promptText = `
Generate a detailed and most optimized solution using stl functions (where can be used) for the following coding problem:
...
1. Code: A clean, most optimized implementation in ${language}
